...
<GetCategoryFeaturesRequest xmlns="urn:ebay:apis:eBLBaseComponents">
  ...
  <ViewAllNodes>true</ViewAllNodes>
    ...
    if(features) {
       console.log("Listing Durations Allowed:", JSON.stringify(features.ListingDuration, null, 2));
       ...
       console.log("No category features found or error:", result.GetCategoryFeaturesResponse?.Errors);
    }
