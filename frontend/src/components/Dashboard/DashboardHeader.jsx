import { Camera, Package, Plus, Users, Bell, Mail, User, Settings, HelpCircle, LogOut } from 'lucide-react';
      ...
      <div className="px-6 py-4">
        <div className="flex items-center justify-between gap-4 mb-4">
          ...
          <div className="flex items-center gap-3">
            <button className="p-2.5 bg-white hover:bg-gray-50 rounded-lg relative shadow-sm border border-gray-200 transition-colors" title="Notifications">
              <Bell className="w-5 h-5 text-gray-600" />
              <span className="absolute top-1.5 right-1.5 w-2 h-2 bg-red-500 rounded-full"></span>
            </button>
            
            <button className="p-2.5 bg-white hover:bg-gray-50 rounded-lg relative shadow-sm border border-gray-200 transition-colors" title="Messages">
            ...
            <div className="relative" ref={menuRef}>
              <button 
                ...
                className="flex items-center gap-2.5 px-3 py-2 bg-white hover:bg-gray-50 rounded-lg shadow-sm border border-gray-200 transition-colors"
              >
                  ...
                  <div className="px-4 py-3 border-b border-gray-100">
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="text-sm font-semibold text-gray-900 truncate">{user.name || 'User Name'}</div>
