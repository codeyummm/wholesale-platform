               ...
               <div className="p-6">
                  ...
                  <div className="text-[13px] font-medium text-gray-500 mb-6 flex flex-col gap-1.5 pt-1">
                     ...
                     {selectedOrder.externalOrderId ? (
                       <>
                         <span className="flex items-center gap-2"><span className="text-gray-400 text-xs font-black uppercase tracking-widest mr-[-2px] w-[32px] text-left">{selectedOrder.salesChannel === 'shopify' ? 'SHID' : 'EID'}</span> {selectedOrder.externalOrderId}</span>
                         <span className="flex items-center gap-2"><span className="text-gray-400 text-xs font-black uppercase tracking-widest mr-[-2px] w-[32px] text-left">SYS</span> {selectedOrder.saleNumber}</span>
                       </>
                     ) : (
